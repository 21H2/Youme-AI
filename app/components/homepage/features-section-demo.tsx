  ...
  const features = [
    {
      ...
      description:
        "Generate optimized titles, descriptions, and thumbnails for your YouTube videos using advanced AI.",
    ...
    },
    {
      ...
      description:
        "Create eye-catching thumbnails with AI assistance and proven design patterns.",
    ...
    },
    {
      ...
      description:
        "Seamlessly integrate with YouTube to optimize your content and grow your channel.",
    ...
    },
    {
      ...
      description:
        "Your AI agents work 24/7 across the globe, helping creators worldwide optimize their content.",
    ...
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
      <div className="px-8">
        ...
        <p className="text-sm lg:text-base max-w-2xl my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300">
          From AI-powered title generation to thumbnail creation, Youme AI has everything you need to create viral content.
        </p>
      </div>
...
export const SkeletonThree = () => {
  return (
    <a
      href="https://www.youtube.com/@youmeai"
      target="_blank"
