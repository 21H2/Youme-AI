        ...
        <section >
            ...
            <div className="pt-[4rem] px-[2rem]">
                <div className="text-center">
                    <h1 className="mx-auto mt-16 max-w-xl text-5xl text-balance font-medium">Introducing Youme AI</h1>
                ...
                <div className="flex justify-center">
                    <VideoPlayer src="https://if23e7z3v4.ufs.sh/f/7ByLKVi13sd55KcPV3WOGMLFlPCYAxHVZTQRynBKwagie07f" />
                </div>
            </div>
        </section>
    )
